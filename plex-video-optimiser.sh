...
OUTPUT_FILE_NAME=$(echo ${OUTPUT_FILE_NAME} | sed 's/[\ \.]\(HEVC\|x264\|x265\|HDR\|Blu-ray\|BluRay\)//g')
OUTPUT_FILE_NAME=$(echo ${OUTPUT_FILE_NAME} | sed 's/[\ \.]\(Remux\|REMUX\|WEBRip\)//g')
OUTPUT_FILE_NAME=$(echo ${OUTPUT_FILE_NAME} | sed 's/[\ \.]\(Atmos\|DTS-HD[\ \.]MA\|DTSX\|TrueHD\|5.1\|6.1\|7\.1\)//g')
