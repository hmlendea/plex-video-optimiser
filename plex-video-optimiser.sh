...
OUTPUT_FILE_NAME=$(echo "${OUTPUT_FILE_NAME}" | sed 's/[-\ \.]*\(AC3\|AAC2\.0\|Atmos\|[Dd][Dd][Pp]*2\.0\|DTS-MA\|DTS-X\|DTS\|FLAC[-\ \.]*2[\.]0\|HD[-\ \.]MA\|LPCM\|DD+\|DD[P]*[\.]*[567]\.1\|DTSX\|FLAC[-\ \.][567]\.1\|TrueHD\|[567]\.1\)//g')
