...
OUTPUT_FILE_NAME=$(echo ${OUTPUT_FILE_NAME} | sed 's/[-\ \.]*\(HEVC\|x264\|x265\|-AJP69\|Blu-ray\|BluRay\)//g')
OUTPUT_FILE_NAME=$(echo ${OUTPUT_FILE_NAME} | sed 's/[-\ \.]*\(REPACK\|Remux\|REMUX\|WEBRip\|AMZN\)//g')
OUTPUT_FILE_NAME=$(echo ${OUTPUT_FILE_NAME} | sed 's/[-\ \.]*\(AC3\|Atmos\|DTS\|HD[-\ \.]MA\|DD+\|DTSX\|TrueHD\|5.1\|6.1\|7\.1\)//g')
OUTPUT_FILE_NAME=$(echo ${OUTPUT_FILE_NAME} | sed 's/[-\ \.]*\(ETRG\|FraMeSToR\|playBD\|MovietaM\|HDMaN\|BLUEBIRD\|TrollUHD\)//g')
